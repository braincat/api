...
public class HmacAuthorizationHeaderTests {
    ...
    public void test_parse_ThrowsAnException_WhenTheStringDoesNotContainAColonCharacter() {
        HmacAuthorizationHeader.parse("123");
    }

    @Test(expected = IllegalArgumentException.class)
    public void test_parse_ThrowsAnException_WhenTheStringContainsMoreThanOneColonCharacter() {
